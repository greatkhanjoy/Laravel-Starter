        ...
        <div class="w-full shadow-md p-4 mx-auto">
            ...
            <form action="{{ route('admin.user.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5  mt-10">
                    ...
                    <div class="mb-6">
                        <label for="roles"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Assign Role</label>
                    ...
                    <div class="mb-6">
                        <label for="permissions"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Grant
                            Permissions</label>
                        <select name="permissions[]" id="permissions" multiple class="w-full">
                            @foreach ($permissions as $permission)
                                <option @if ($user->getDirectPermissions()->contains('id', $permission->id)) selected @endif value="{{ $permission->id }}">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="file" id="image" accept="jpeg,png,gif" name="image"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        @error('image')
                            <p class="text-sm text-red-500">{{ $message }}</p>
                        @enderror
