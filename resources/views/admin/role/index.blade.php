<x-admin-layout>
    ...
    <div class="container">
        <div class="w-full  flex justify-between items-center mb-2">
            <h2>Roles</h2>
            <a href="{{route('admin.role.create')}}" class="px-3 py-2 bg-green-500 text-white flex items-center gap-2"><ion-icon name="add-circle-outline"></ion-icon> <span>Add new role</span></a>
        </div>
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-6 py-4 text-right flex gap-1 justify-end">
                            <a href="{{route('admin.role.edit', $role->id)}}" class="bg-blue-500 text-white text-lg px-2 py-1 leading-none hover:bg-blue-600" ><ion-icon name="create-outline"></ion-icon></a>
